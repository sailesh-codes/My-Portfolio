...
export const ProstheticsSection: React.FC = () => {
  return (
    <section id="prosthetics" className="relative min-h-screen overflow-hidden bg-[#f0f0ee] z-20">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <nav className="flex items-center justify-center pt-4 sm:pt-6 px-4 sm:px-8 gap-2 sm:gap-3">
          ...
          <a
            href="#"
            className="flex items-center justify-center rounded-full w-10 h-10 sm:w-11 sm:h-11 shrink-0 transition-transform duration-200 hover:scale-105 shadow-sm"
